...
import com.sjjd.wyl.flipbook.R;
import com.sjjd.wyl.flipbook.animation.CoverPageAnim;
import com.sjjd.wyl.flipbook.animation.HorizonPageAnim;
import com.sjjd.wyl.flipbook.animation.NonePageAnim;
import com.sjjd.wyl.flipbook.animation.PageAnimation;
import com.sjjd.wyl.flipbook.animation.ScrollPageAnim;
import com.sjjd.wyl.flipbook.animation.SimulationPageAnim;
import com.sjjd.wyl.flipbook.animation.SlidePageAnim;
...
public class PageView extends View {
    ...
    public PageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTipPaint.setTextSize(30); // Tip默认的字体大小
        mTipPaint.setAntiAlias(true);
        mTipPaint.setSubpixelText(true);
        // 设置当前颜色样式
        mTipPaint.setColor(ContextCompat.getColor(context, R.color.red));
    }
    ...
    void setPageMode(PageMode pageMode) {
        ...
        switch (mPageMode) {
            ...
            case NONE:
                ...
                break;
            case SCROLL:
                mPageAnim = new ScrollPageAnim(mViewWidth, mViewHeight, 00,
     ...
     * @return
     */
    public PageLoader getPageLoader(List<Bitmap> list) {
        // 判是否已经存在
        if (mPageLoader != null) {
            return mPageLoader;
        }
        // 根据书籍类型，获取具体的加载器
        mPageLoader = new PageLoader(this, list);
